            ...
            @foreach ($komiks as $item)
                <div>
                    <div class="p-7 rounded-md border bg-gray-50 shadow-md dark:bg-neutral-700/70">
                        ...
                        <p class="font-medium leading-7 text-gray-500 mb-6 dark:text-gray-400">{{ $item->description }}</p>
                        <a href="/detail/{{ $item->id }}" class="py-3 flex items-center justify-center w-full font-semibold rounded-md bg-white hover:bg-purple-500 hover:text-white transition-all duration-500 gap-2">
