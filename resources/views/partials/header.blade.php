        ...
        <nav class="flex justify-between bg-gray-900 text-white w-screen">
            <div class="px-5 xl:px-12 py-3 flex w-full items-center">
                ...
                <div class="hidden xl:flex items-center space-x-5 items-center">
                    <a class="hover:text-gray-200" href="{{ route('wishList') }}">
                    ...
                    <div class="relative">
                        @if (Auth::check())
                            <a class="flex items-center hover:text-gray-200 cursor-pointer" id="userMenuButton">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <!-- Dropdown Menu -->
                            <div id="userMenu" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg hidden z-60">
                                <ul class="py-1 text-gray-700">
                                    <li>
                                        <a href="/profile" class="block px-4 py-2 hover:bg-gray-100">Profil</a>
                                    </li>
                                    <li>
                                        <a href="/order-list" class="block px-4 py-2 hover:bg-gray-100">Transaksi</a>
                                    </li>
                                    <li>
                                        <a href="/settings" class="block px-4 py-2 hover:bg-gray-100">Pengaturan</a>
                                    </li>
                                    <li>
                                        <form action="/logout" method="POST">
                                            @csrf
                                            <button type="submit" class="text-left w-full px-4 py-2 hover:bg-gray-100 text-red-600">Keluar</button>
                                        </form>
                                    </li>
                                </ul>
                            </div>
